...
type SortKey = "grp" | "program" | "garduInduk" | "bay" | "ultg" | "status" | "targetDate" | "realisasiDate";
type SortDir = "asc" | "desc";

interface ProteksiDetailTableProps {
  rows: ProteksiDetailRow[];
...
function ultgColor(ultg: ProteksiDetailRow["ultg"]): string {
...
export function ProteksiDetailTable({
  ...
  /* ── Reset page kalau filter berubah dan page jadi out-of-range ── */
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12.5 }}>
          <thead>
            <tr style={{ background: "var(--bg-2)" }}>
              ...
              <Th label="Target" sortKey="targetDate" active={sortKey === "targetDate"} dir={sortDir} onSort={handleSort} align="center" />
              <Th label="Realisasi" sortKey="realisasiDate" active={sortKey === "realisasiDate"} dir={sortDir} onSort={handleSort} align="center" />
          ...
          <tbody>
            {pageRows.map((r, i) => {
              ...
              return (
                ...
                >
                  ...
                  <td style={td("center", true, "var(--fg-1)")}>{r.targetDate || EM_DASH}</td>
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={10} style={{ padding: 32, textAlign: "center", color: "var(--fg-2)", fontSize: 12 }}>
