...
const SPREADSHEET_ID = "1aSi-mBeRnpUvSuNQ_U4HZbLxpmqwt2Fwh8koJVslqIg";
const SHEET_NAME = "MTU Trafo";
...
export async function GET() {
    try {
        ...
        console.error("[/api/hi-trafo] Error:", err);
        return NextResponse.json(
            { error: "Failed to fetch HI Trafo data", detail: String(err) },
            { status: 500 },
        );
    }
}
