...
interface KerawananTransmisiPageProps {
    embedded?: boolean;
}

export default function KerawananTransmisiPage({ embedded = false }: KerawananTransmisiPageProps = {}) {
            ...
            <Card className="flex-grow min-h-[400px] overflow-hidden border-border/50 shadow-sm relative shrink-0">
                {loading && (
                    <div className="absolute inset-0 z-10 bg-background/50 backdrop-blur-sm flex items-center justify-center space-x-2">
                        ...
                        <span className="ml-2 text-sm font-medium">Memuat Peta Geospatial...</span>
                    </div>
                )}
