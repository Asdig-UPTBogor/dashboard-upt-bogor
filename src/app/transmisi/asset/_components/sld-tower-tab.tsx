...
interface SLDTowerPageProps {
    embedded?: boolean;
}

export default function SLDTowerPage({ embedded = false }: SLDTowerPageProps = {}) {
                                        ...
                                        <TableRow key={i} className="hover:bg-muted/50 transition-colors">
                                            ...
                                            <TableCell className="text-xs">
                                                <div className="flex items-center gap-1.5 max-w-[200px]">
                                                    {r[COL.SLD] && String(r[COL.SLD]).startsWith("http") ? (
                                                        <a href={r[COL.SLD]} target="_blank" rel="noopener noreferrer" className="truncate text-blue-500 hover:text-blue-600 hover:underline flex items-center gap-1" title={r[COL.SLD]}>
