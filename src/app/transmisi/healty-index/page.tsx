        ...
        return {
            ...
            graphic: [{
                ...
                style: {
                    ...
                    fill: "#e4e4e7", textAlign: "center" as const,
                },
            }, {
                type: "text" as const,
                left: "center", top: "50%",
                style: {
                    text: "tower",
                    fontSize: 11, fill: "#71717a", textAlign: "center" as const,
                },
            }],
            series: [{
                type: "pie" as const,
    ...
    const stackedBarOption = useMemo(() => {
        ...
        return {
            ...
            yAxis: {
                ...
                data: shortGI,
                axisLabel: { fontSize: 9, color: "#d4d4d8", width: 200, overflow: "truncate" as const },
                axisLine: { show: false },
                axisTick: { show: false },
                inverse: true,
            },
    ...
    const avgHIBarOption = useMemo(() => ({
        ...
        tooltip: {
            ...
            formatter: (params: Array<{ name: string; value: number }>) => {
                ...
                return `<b style="color:#fff">${p.name}</b><br/>Avg HI: <b>${p.value.toFixed(1)}</b><br/>Tower: ${info?.count || 0}`;
            },
        },
        ...
        yAxis: {
            ...
            axisLabel: {
                fontSize: 9, color: "#d4d4d8", width: 200,
