                ...
                >
                    {popupType === "cluster" ? (
                        ...
                        <div className="p-1 space-y-2 min-w-[200px] text-slate-800 dark:text-slate-200">
                            ...
                            <div className="text-xs space-y-1">
                                <p><span className="font-semibold text-slate-500">ULTG:</span> {popupInfo["MASTER ULTG"]}</p>
                                <p><span className="font-semibold text-slate-500">GI:</span> {popupInfo["MASTER GARDU INDUK"]}</p>
