...
async function main() {
    console.log("Fetching KLASIFIKASI_BAY (FORMULAS)...");
    try {
        ...
        console.log(`\n========================================`);
        console.log("KLASIFIKASI_BAY (RAW FORMULAS) Sample:");
        console.log(`========================================\n`);
        ...
        console.error("Error analyzing spreadsheet formulas:", err?.message || err);
    }
}
main();
